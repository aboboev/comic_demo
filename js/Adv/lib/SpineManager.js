...
SpineManager.prototype.load = function( key, cb )
{
    this.key = key;
...
SpineManager.prototype.resourceLoad = function( Idx )
{
    ...
    var image = new Image();
    this._datas[Idx] = {
        data: JSON.parse(resources["resource/spine/" + this._path[Idx] + "/" + this._path[Idx] + ".json"]),
        atlas: resources["resource/spine/" + this._path[Idx] + "/" + this._path[Idx] + ".atlas"],
        image: image
    };
